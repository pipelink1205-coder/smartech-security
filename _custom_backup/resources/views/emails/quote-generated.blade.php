...
.top{background:#16a34a;padding:28px 32px;color:white;}
...
.badge .num{font-size:22px;font-weight:800;color:#16a34a;}
...
.btn{display:block;background:#16a34a;color:white;text-align:center;padding:13px;border-radius:8px;text-decoration:none;font-weight:700;font-size:14px;margin-top:24px;}
...
<div class="card">
  <div class="top">
    ...
    <p>Seguridad, Energía Solar &amp; IPTV · Medellín</p>
  </div>
  <div class="body">
    ...
    <a href="https://wa.me/{{ config('app.whatsapp', '573040000000') }}" class="btn">
      Escríbenos por WhatsApp 💬
    </a>
  </div>
  <div class="footer">
    Smart Tech Security · info@smarttechsecurity.com.co<br/>
